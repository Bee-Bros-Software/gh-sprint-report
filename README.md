...
| Burnup | Completed work rising toward scope — the view that shows scope change |
| Velocity | Committed and completed per sprint as lines, with a recent average and predictability percentages |
